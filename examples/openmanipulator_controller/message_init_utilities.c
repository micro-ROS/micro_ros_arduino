...
trajectory_msgs__msg__JointTrajectory * create_joint_trajectory_msg(){
  ...
  rosidl_runtime_c__String__Sequence__init(&msg->joint_names, 5); // Number of join in arm
  ...
  for (size_t i = 0; i < n_points; i++){
      rosidl_runtime_c__float64__Sequence__init(&msg->points.data[i].positions, 5);
      rosidl_runtime_c__float64__Sequence__init(&msg->points.data[i].velocities, 5);
      rosidl_runtime_c__float64__Sequence__init(&msg->points.data[i].accelerations, 5);
      rosidl_runtime_c__float64__Sequence__init(&msg->points.data[i].effort, 5);
  }
    return msg;
}
