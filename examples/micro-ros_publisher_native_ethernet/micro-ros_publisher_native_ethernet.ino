...
// For this example, you might start the agent with something like this:
...
// If DHCP fails, the following self assigned IP will be used instead
IPAddress fallback_client_ip(192,168,1,100);
...
void setup() {
  ...
  set_microros_native_ethernet_udp_transports( mac, fallback_client_ip, agent_ip, agent_port  );
