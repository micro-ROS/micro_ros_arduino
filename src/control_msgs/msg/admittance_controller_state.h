...
#ifndef CONTROL_MSGS__MSG__ADMITTANCE_CONTROLLER_STATE_H_
#define CONTROL_MSGS__MSG__ADMITTANCE_CONTROLLER_STATE_H_
...
#endif  // CONTROL_MSGS__MSG__ADMITTANCE_CONTROLLER_STATE_H_
