...
#ifndef VISUALIZATION_MSGS__MSG__UV_COORDINATE__ROSIDL_TYPESUPPORT_MICROXRCEDDS_C_H_
...
#endif  // VISUALIZATION_MSGS__MSG__UV_COORDINATE__ROSIDL_TYPESUPPORT_MICROXRCEDDS_C_H_
