...
#ifndef RCL_INTERFACES__MSG__LOGGER_LEVEL__ROSIDL_TYPESUPPORT_MICROXRCEDDS_C_H_
...
#endif  // RCL_INTERFACES__MSG__LOGGER_LEVEL__ROSIDL_TYPESUPPORT_MICROXRCEDDS_C_H_
